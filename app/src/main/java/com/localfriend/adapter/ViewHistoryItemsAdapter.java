...
public class ViewHistoryItemsAdapter extends BaseAdapter {

    private LayoutInflater layoutInflater;
    private boolean isGrid;
    private List<HistoryList> listData;

    public ViewHistoryItemsAdapter(Context context, boolean isGrid, List<HistoryList> listData) {
